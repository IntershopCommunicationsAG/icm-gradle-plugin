...
There is one preconfigured base configuration "main". The pathe for the configuration is 'configuration/base' and for sites it is 'sites/base'.
*Both directories must be available in a project.*

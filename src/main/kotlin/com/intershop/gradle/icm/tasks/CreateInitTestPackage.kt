 ...
 */
open class CreateInitTestPackage: Tar() {

    companion object {
        const val DEFAULT_NAME = "createInitTestPkg"
    }

    init {
        group = "ICM server build"
        description = "Create the package of init test artifacts for the Docker build"

        archiveBaseName.set("inittestpkg")
        archiveVersion.set("")

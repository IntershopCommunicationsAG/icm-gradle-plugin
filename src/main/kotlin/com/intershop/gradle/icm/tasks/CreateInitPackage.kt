 ...
 */
open class CreateInitPackage: Tar() {

    companion object {
        const val DEFAULT_NAME = "createInitPkg"
    }

    init {
        group = "ICM server build"
        description = "Create the package of init artifacts for the Docker build"

        archiveBaseName.set("initpkg")
        archiveVersion.set("")
